...
<?php
include("connectionquote.php");

$query = "SELECT * FROM info_quote";
 ...
 <div class="d-flex" id="wrapper">
        ...
        <div class="bg-white" id="sidebar-wrapper">
            ...
            <div class="list-group list-group-flush my-3">
                ...
                <a href="adminhome2.php" class="list-group-item list-group-item-action bg-transparent second-text fw-bold active"><i
                ...
                <div class="row g-3 my-2">
                    <div class="col-md-4">
                        <div class="p-3 bg-white shadow-sm d-flex justify-content-around align-items-center rounded">
                            ...
                            <i class="fas fa-quote-right fs-1 primary-text border rounded-full secondary-bg p-3"></i>
                        </div>
                    </div>
            ...
            <div class="container-fluid px-4">
                <div class="row g-3 my-2">
                    <div class="col-md-8 bg-head">
                       <h2 >People who want quote from us</h2>
                    </div>
                    <div class="col-md-4">
